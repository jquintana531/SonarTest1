...
export declare class OwlYearViewComponent<T> implements OnInit, AfterContentInit, OnDestroy {
    ...
    readonly pickerDayjsChange: EventEmitter<T>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OwlYearViewComponent<any>, "owl-date-time-year-view", ["owlMonthView"], { "selectMode": "selectMode"; "selected": "selected"; "selecteds": "selecteds"; "pickerDayjs": "pickerDayjs"; "dateFilter": "dateFilter"; "minDate": "minDate"; "maxDate": "maxDate"; }, { "change": "change"; "monthSelected": "monthSelected"; "pickerDayjsChange": "pickerDayjsChange"; "keyboardEnter": "keyboardEnter"; }, never, never>;
}
