...
export declare class OwlCalendarComponent<T> implements OnInit, AfterContentInit, AfterViewChecked, OnDestroy {
    ...
    pickerDayjsChange: EventEmitter<T>;
     ...
     */
    handlePickerDayjsChange(date: T): void;
    userSelected(): void;
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OwlCalendarComponent<any>, "owl-date-time-calendar", ["owlDateTimeCalendar"], { "dateFilter": "dateFilter"; "firstDayOfWeek": "firstDayOfWeek"; "minDate": "minDate"; "maxDate": "maxDate"; "pickerDayjs": "pickerDayjs"; "selectMode": "selectMode"; "selected": "selected"; "selecteds": "selecteds"; "startView": "startView"; "hideOtherMonths": "hideOtherMonths"; }, { "pickerDayjsChange": "pickerDayjsChange"; "selectedChange": "selectedChange"; "userSelection": "userSelection"; "yearSelected": "yearSelected"; "monthSelected": "monthSelected"; }, never, never>;
}
