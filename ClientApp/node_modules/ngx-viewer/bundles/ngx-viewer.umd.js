(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('viewerjs')) :
    typeof define === 'function' && define.amd ? define('ngx-viewer', ['@angular/core','exports', '@angular/core', 'viewerjs'], factory) :
    (global = global || self, factory(global.ng.core,global['ngx-viewer'] = {}, global.ng.core, global.Viewer));
}(this, (function (ɵngcc0,exports, core, Viewer) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxViewerDirective = /** @class */ (function () {
        function NgxViewerDirective(elementRef) {
            ...
            this.viewerOptions = {};
            this.viewerReady = new core.EventEmitter();
            this.viewerShow = new core.EventEmitter();
            this.viewerShown = new core.EventEmitter();
            this.viewerHide = new core.EventEmitter();
            this.viewerHidden = new core.EventEmitter();
            this.viewerView = new core.EventEmitter();
            this.viewerViewed = new core.EventEmitter();
            this.viewerZoom = new core.EventEmitter();
            this.viewerZoomed = new core.EventEmitter();
        ...
        NgxViewerDirective.propDecorators = {
            ...
            viewerReady: [{ type: core.Output }],
            viewerShow: [{ type: core.Output }],
            viewerShown: [{ type: core.Output }],
            viewerHide: [{ type: core.Output }],
            viewerHidden: [{ type: core.Output }],
            viewerView: [{ type: core.Output }],
            viewerViewed: [{ type: core.Output }],
            viewerZoom: [{ type: core.Output }],
            viewerZoomed: [{ type: core.Output }]
        };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxViewerModule, { declarations: [NgxViewerDirective], exports: [NgxViewerDirective] }); })();
    ...
    exports.NgxViewerDirective = NgxViewerDirective;
    exports.NgxViewerModule = NgxViewerModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-viewer.umd.js.map