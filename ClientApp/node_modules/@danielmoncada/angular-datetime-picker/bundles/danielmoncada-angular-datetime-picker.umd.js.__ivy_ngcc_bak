(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@danielmoncada/angular-datetime-picker', ['exports', '@angular/core', '@angular/common', '@angular/cdk/a11y', '@angular/cdk/overlay', 'rxjs', '@angular/cdk/portal', '@angular/cdk/keycodes', '@angular/cdk/coercion', 'rxjs/operators', '@angular/animations', '@angular/forms', '@angular/cdk/platform'], factory) :
    (global = global || self, factory((global.danielmoncada = global.danielmoncada || {}, global.danielmoncada['angular-datetime-picker'] = {}), global.ng.core, global.ng.common, global.ng.cdk.a11y, global.ng.cdk.overlay, global.rxjs, global.ng.cdk.portal, global.ng.cdk.keycodes, global.ng.cdk.coercion, global.rxjs.operators, global.ng.animations, global.ng.forms, global.ng.cdk.platform));
}(this, (function (exports, i0, common, a11y, overlay, rxjs, portal, keycodes, coercion, operators, animations, forms, platform) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    })(exports.DateView || (exports.DateView = {}));
    var OwlDateTime = /** @class */ (function () {
        function OwlDateTime(dateTimeAdapter, dateTimeFormats) {
             ...
             */
            this.startView = exports.DateView.MONTH;
            /**
    ...
    var OwlCalendarComponent = /** @class */ (function () {
        function OwlCalendarComponent(elmRef, pickerIntl, ngZone, cdRef, dateTimeAdapter, dateTimeFormats) {
            ...
            this.dateTimeAdapter = dateTimeAdapter;
            this.dateTimeFormats = dateTimeFormats;
            this.DateView = exports.DateView;
            this._selecteds = [];
            /**
             * The view that the calendar should start in.
             */
            ...
            this.dateClicked = new i0.EventEmitter();
        ...
        Object.defineProperty(OwlCalendarComponent.prototype, "prevButtonLabel", {
            get: function () {
                if (this._currentView === exports.DateView.MONTH) {
                    return this.pickerIntl.prevMonthLabel;
                }
                else if (this._currentView === exports.DateView.YEAR) {
        ...
        Object.defineProperty(OwlCalendarComponent.prototype, "showControlArrows", {
            get: function () {
                return this._currentView !== exports.DateView.MULTI_YEARS;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(OwlCalendarComponent.prototype, "isMonthView", {
            get: function () {
                return this._currentView === exports.DateView.MONTH;
            },
            enumerable: false,
            configurable: true
        });
        ...
        OwlCalendarComponent.prototype.toggleViews = function () {
            var nextView = null;
            if (this._currentView === exports.DateView.MONTH) {
                nextView = exports.DateView.MULTI_YEARS;
            }
            else {
                if (this.multiyearOnly) {
                    ...
                    nextView = this._currentView === exports.DateView.YEAR ? exports.DateView.MULTI_YEARS : exports.DateView.YEAR;
                }
                else {
                    nextView = exports.DateView.MONTH;
                }
            }
        ...
        OwlCalendarComponent.prototype.goToDateInView = function (date, view) {
            ...
            if ((!this.yearOnly && !this.multiyearOnly) ||
                (this.multiyearOnly && (view !== exports.DateView.MONTH && view !== exports.DateView.YEAR)) ||
                (this.yearOnly && view !== exports.DateView.MONTH)) {
    ...
    var OwlDateTimeComponent = /** @class */ (function (_super) {
         ...
         * */
        OwlDateTimeComponent.prototype.selectDate = function (normalizedDate) {
        ...
        OwlDateTimeComponent.prototype.close = function () {
            ...
            var completeClose = function () {
                if (_this._opened) {
                    _this._opened = false;
                    var selected = _this.selected || _this.selecteds;
                    _this.afterPickerClosed.emit(selected);
                    _this.focusedElementBeforeOpen = null;
                }
            };
    ...
    var OwlMonthViewComponent = /** @class */ (function () {
        ...
        OwlMonthViewComponent.prototype.ngOnInit = function () {
            ...
            this.localeSub = this.dateTimeAdapter.localeChanges.subscribe(function (locale) {
                _this.updateFirstDayOfWeek(locale);
        ...
        OwlMonthViewComponent.prototype.updateFirstDayOfWeek = function (locale) {
            if (this.isDefaultFirstDayOfWeek) {
                try {
                    this._firstDayOfWeek = common.getLocaleFirstDayOfWeek(locale);
                }
                catch (_a) {
    ...
    var DefaultOptions = /** @class */ (function () {
        ...
        DefaultOptions.create = function () {
    ...
    var OptionsTokens = /** @class */ (function () {
        function OptionsTokens() {
        }
        return OptionsTokens;
    }());
    OptionsTokens.all = new i0.InjectionToken('All options token');
    OptionsTokens.multiYear = new i0.InjectionToken('Grid view options token');
    ...
    var OwlMultiYearViewComponent = /** @class */ (function () {
        function OwlMultiYearViewComponent(cdRef, pickerIntl, dateTimeAdapter, options) {
            this.cdRef = cdRef;
            this.pickerIntl = pickerIntl;
            this.dateTimeAdapter = dateTimeAdapter;
        ...
        OwlMultiYearViewComponent.prototype.generateYearList = function () {
            ...
            var offset = pickerMomentYear % (this.options.yearsPerRow * this.options.yearRows);
            for (var i = 0; i < this.options.yearRows; i++) {
                var row = [];
                for (var j = 0; j < this.options.yearsPerRow; j++) {
                    var year = pickerMomentYear - offset + (j + i * this.options.yearsPerRow);
    ...
    OwlMultiYearViewComponent.ctorParameters = function () { return [
        ...
        { type: OwlDateTimeIntl },
        { type: DateTimeAdapter, decorators: [{ type: i0.Optional }] },
        { type: undefined, decorators: [{ type: i0.Inject, args: [OptionsTokens.multiYear,] }] }
    ]; };
    ...
    var OwlTimerBoxComponent = /** @class */ (function () {
        ...
        Object.defineProperty(OwlTimerBoxComponent.prototype, "displayValue", {
            get: function () {
                ...
                var value = this.boxValue || this.value;
        ...
        OwlTimerBoxComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.inputStreamSub = this.inputStream.subscribe(function (val) {
                if (val) {
        ...
        OwlTimerBoxComponent.prototype.focusIn = function () {
            this.hasFocus = true;
        };
    ...
    var OwlDateTimeInlineComponent = /** @class */ (function (_super) {
         ...
         * Emits the selected date
         * */
        OwlDateTimeInlineComponent.prototype.selectDate = function (normalizedDate) {
            this.dateSelected.emit(normalizedDate);
        };
    ...
    exports.OptionsTokens = OptionsTokens;
    ...
    exports.defaultOptionsFactory = defaultOptionsFactory;
    exports.multiYearOptionsFactory = multiYearOptionsFactory;
    exports.optionsProviders = optionsProviders;
    ...
    exports.ɵg = OwlDateTime;
    exports.ɵh = OwlDialogModule;
    exports.ɵi = OwlDialogContainerComponent;
    exports.ɵj = OWL_DIALOG_SCROLL_STRATEGY;
    exports.ɵk = OWL_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY;
    exports.ɵl = OWL_DIALOG_SCROLL_STRATEGY_PROVIDER;
    exports.ɵm = OWL_DIALOG_DEFAULT_OPTIONS;
    exports.ɵn = OwlDialogService;
    exports.ɵp = OwlDateTimeContainerComponent;
    exports.ɵq = owlDateTimePickerAnimations;
    exports.ɵr = OwlTimerBoxComponent;
    exports.ɵs = NumberFixedLenPipe;
    exports.ɵt = OWL_NATIVE_DATE_TIME_FORMATS;
