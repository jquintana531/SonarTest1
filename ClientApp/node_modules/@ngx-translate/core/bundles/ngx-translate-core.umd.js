(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@ngx-translate/core', ['@angular/core','exports', 'tslib', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (factory(global.ng.core,(global['ngx-translate'] = global['ngx-translate'] || {}, global['ngx-translate'].core = {}),global.tslib,global.ng.core,global.rxjs,global.Rx.Observable.prototype));
}(this, (function (ɵngcc0,exports,tslib,core,rxjs,operators) { 'use strict';
    ...
    var TranslateFakeLoader = (function (_super) {
        tslib.__extends(TranslateFakeLoader, _super);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(FakeMissingTranslationHandler, [{
    ...
    var TranslateFakeCompiler = (function (_super) {
        tslib.__extends(TranslateFakeCompiler, _super);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslateFakeCompiler, [{
    ...
    var TranslateDefaultParser = (function (_super) {
        tslib.__extends(TranslateDefaultParser, _super);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslateDefaultParser, [{
    ...
    var /** @type {?} */ USE_STORE = new core.InjectionToken('USE_STORE');
    var /** @type {?} */ USE_DEFAULT_LANG = new core.InjectionToken('USE_DEFAULT_LANG');
        ...
        TranslateService.prototype.getParsedResult = function (translations, key, interpolateParams) {
            ...
            if (key instanceof Array) {
                ...
                if (observables) {
                    ...
                    try {
                        for (var key_2 = tslib.__values(key), key_2_1 = key_2.next(); !key_2_1.done; key_2_1 = key_2.next()) {
                            var k = key_2_1.value;
                            var /** @type {?} */ obs = typeof result[k].subscribe === "function" ? result[k] : rxjs.of(/** @type {?} */ (result[k]));
